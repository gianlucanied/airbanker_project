...
<template>
  <footer class="footer" data-aos="flip-up" data-aos-duration="1000">
    ...
    <!-- Div per particles, dentro il footer -->
    <div class="logo-img">
...
#particles-js {
  position: absolute; /* Posiziona il div dietro al contenuto */
  top: 0;
  left: 0;
  width: 100%;
  height: 100%;
  z-index: 0; /* Assicurati che il canvas delle particles stia dietro */
  pointer-events: none; /* Permette agli eventi del puntatore di passare attraverso */
}
.footer {
...
.logo-img img {
  width: 250px; /* Mantieni la larghezza del logo */
  border-radius: 10px; /* Arrotonda i bordi dell'immagine */
}
